            ...
            <div className="px-4 py-6 sm:px-0">
                ...
                <div className="mt-4 p-4 bg-red-50 border border-red-200 rounded-md">
                    <p className="text-xs text-red-800">
                        <strong>⚠️ BASELINE VERSION - HEAVY PAGE:</strong> This page imports country-state-city library (~9MB of location data).
                        In this BASELINE version, this gets bundled into the main chunk, so even the Login page loads this massive library!
                    </p>
